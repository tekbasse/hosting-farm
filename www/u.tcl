...
# When user chooses a user, contact_user_id is passed to assets.tcl or monitors.tcl
...
set title "#accounts-ledger.Users#"
...
set user_id_list [qc_contact_ids_for_user $user_id $instance_id]
if { [llength $user_id_list] > 1 } {
     set gt1_user_p 1
} else {
    set contact_user_id [lindex $user_id_list 0]
}

#if gt1_user_p = 0, just show link to assets and monitors
...
if { !$form_posted_p } {
    ...
    # this is mainly for admins.. or anyone with a long list of users
}
