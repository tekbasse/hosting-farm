...
<if @include_view_attr_p@ true>
  <include src="/packages/hosting-farm/lib/attribute-view" &attr_arr=obj_arr &perms_arr=perms_arr detail_p="@detail_p@" tech_p="@tech_p@" asset_type="@asset_type@">
</if>
